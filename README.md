...
#
#### Legal notice
- <img src="https://github.com/AC8L/QMX_Plus_Autotuner_Internal_Battery_Speaker/blob/main/Photos/QRG_Lab_Logo.png" width=50% height=50%>, QMX and QMX+ are trademarks of Hans Summers (G0UPL).
