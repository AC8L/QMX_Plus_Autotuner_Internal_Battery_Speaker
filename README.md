...
<code style="color : red">Anyone who wants to commercialize and sell this solution as modules, semi kit or as a full kit are allowed to do so under these terms:

 – Commercial seller can not alter design and has to keep it in it’s original published form.

 – Recognition of originators and designers AC8L and WB2CBA for their work on their site.</code>
