...
- Since this project is an open source, the permission to use trademarks mentioned is not transferred automatically in case parts of this project is reused for other project(s). Each new project originator(s) must obtain the explicit permission from trademark owner.
